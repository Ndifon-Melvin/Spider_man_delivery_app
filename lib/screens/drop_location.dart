...
import 'package:flutter_application_1/screens/package_information.dart';
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            SizedBox(height: 20),
            Text('Select drop Location', style: TextStyle(fontSize: 15)),
            SizedBox(height: 15),
            SizedBox(
              height: 40,
              child: TextFormField(
            ...
            SizedBox(height: 15),
            Image(image: AssetImage('assets/images/map3.png')),
            SizedBox(height: 15),
            PasswordWidget(
            ...
            GestureDetector(
              onTap: () => Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => PackageInformation()),
              ),
              child: MyContainer(
                width: double.infinity,
                height: 50,
